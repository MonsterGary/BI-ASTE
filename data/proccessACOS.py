...
def get_transformed_io(data_path):
    ...
    with open(r'E:\PycharmWorkingSpace\BARTABSA-Syntactic\BARTABSA-main\data\acos\lap-eaio\test.tsv', 'w', encoding='utf-8', newline='') as file:
...
if __name__ == '__main__':
    data_bundle = get_transformed_io(r'E:\PycharmWorkingSpace\BARTABSA-Syntactic\BARTABSA-main\data\acos\Laptop-ACOS\laptop_quad_test.tsv')
    print(data_bundle)
