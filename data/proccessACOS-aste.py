...
def get_transformed_io(data_path):
    ...
    with open(r'E:\PycharmWorkingSpace\BARTABSA-Syntactic\BARTABSA-main\data\acos\res2aste\train.txt', 'w', encoding='utf-8', newline='') as file:
...
if __name__ == '__main__':
    data_bundle = get_transformed_io(r'E:\PycharmWorkingSpace\BARTABSA-Syntactic\BARTABSA-main\data\acos\Restaurant-ACOS\rest16_quad_train.tsv')
    print(data_bundle)
